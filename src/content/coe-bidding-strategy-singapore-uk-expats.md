...
- **Not understanding refunds for failed bids**. If you authorise a bid and lose, your funds are refunded but it can take 5-10 working days. Plan cashflow accordingly if you're transferring GBP for the deposit just before bidding. If a delayed refund leaves you cash-short on the next bid round, [SingSaver's Singapore personal loan comparison](https://apply.creatory.singsaver.com.sg/click?o=675&a=3247&sub_id1=eaa-coe-bidding-strategy-singapore-uk-expats) returns indicative APR across the SG bank panel from one form — useful as a short-tenure bridge while the failed-bid refund clears.
