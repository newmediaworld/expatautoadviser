...
const faqItems = [
  ...
  { q: "Do I need a Hong Kong driving licence to lease?", a: "Almost certainly yes, and sooner than most guides suggest. The often-quoted 12 months on an overseas licence comes from regulation 37 of Cap. 374B and applies to visitors — defined as people who arrive in Hong Kong other than to take up residence for a period exceeding 12 months. If you have relocated on a contract longer than a year you are not a visitor and that window does not apply, so get the Hong Kong licence before you drive the leased car. Licences issued by the countries and places listed in Schedule 4 of Cap. 374B — which includes the UK, the United States, Canada, Australia and many (but not all) EU states — can be directly issued without a test, provided you also meet one of the Transport Department eligibility limbs: the licence was issued during a period of at least 6 months residence there, or you have held it for at least 5 years, or you hold a passport from that country. Note that a lessor accepting your overseas licence is a commercial decision on their side, not confirmation that you are entitled to drive." },
