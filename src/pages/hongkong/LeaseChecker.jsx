          ...
          <>
            <div style={cardStyle}>
              ...
              <div>
                ...
                <input style={{ ...inputStyle, fontSize: 16, borderColor: errors.email ? '#dc2626' : '#d1d5db' }} type="email" placeholder="you@example.com" value={form.email} onChange={e => set('email', e.target.value)} />
